...
describe("welcomeEmail", () => {
  it("confirms account creation and includes tracking identifiers", () => {
    const mail = welcomeEmail("Ama Mensah", "https://www.nabusmotors.com/account", {
      registrationId: "TG-2026-00042",
      customerId: "11111111-2222-3333-4444-555555555555",
      supportEmail: "info@nabusmotors.com",
      supportPhone: "+233 27 994 0200",
    });

    expect(mail.subject).toMatch(/Welcome to Nabus Motors/i);
    ...
    expect(mail.text).toContain("Support email: info@nabusmotors.com");
    expect(mail.text).toContain("Support phone: +233 27 994 0200");
    expect(mail.text).toContain("https://www.nabusmotors.com/account");
  ...
  it("escapes customer name in HTML", () => {
    const mail = welcomeEmail("Ama <b>x</b>", "https://www.nabusmotors.com/account");
