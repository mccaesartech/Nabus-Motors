  ...
  return [
    {
      ...
      description: pick(rand, [
        "Passed 150-point True Goshen inspection",
        "Added to True Goshen inventory",
...
const INTERNATIONAL_BRANDS: BrandTemplate[] = [
  ...
  { make: "Mercedes-Benz", count: 50, models: [
  ...
  { make: "Chevrolet", count: 50, models: [
  ...
  { make: "Volkswagen", count: 50, models: [
  ...
  { make: "Land Rover", count: 50, models: [
