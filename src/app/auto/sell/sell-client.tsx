          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-6 space-y-4 text-sm text-muted-foreground">
                ...
                <p>
                  Choose to sell outright, consign your vehicle through our platform, or apply
                  the value as trade-in credit toward your next purchase.
                </p>
              </div>
            </div>
            ...
            <div>
              {submitted ? (
                <div className="border border-border p-8 text-center">
                  ...
                  <h3 className="mt-4 text-lg font-semibold">Appraisal Request Received</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    We will review your vehicle details and contact you within one business day
                    with an initial valuation.
                  </p>
                </div>
              ) : (
