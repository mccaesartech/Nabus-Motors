      ...
      <section className="bg-brand-black py-16 sm:py-20">
        <Container>
          ...
          <p className="mt-4 max-w-xl text-base text-text-secondary">
            A straightforward process designed to help you find the right vehicle
      ...
      <section className="py-14 sm:py-16">
        <Container>
          <div className="grid gap-10 lg:grid-cols-2">
              ...
              <ol className="mt-6 space-y-4">
                {steps.map((step, i) => (
                  <li key={i} className="flex gap-3 text-sm">
                    <span className="flex size-7 shrink-0 items-center justify-center rounded-full bg-brand-purple text-xs font-semibold text-white">
                      {i + 1}
                    </span>
            ...
            <div className="border border-border bg-brand-cream/30 p-6">
